...
```{r prob12a}
part1<-hist(CLEAN$weight[CLEAN$smoke==0], breaks=8)
part2<-hist(CLEAN$weight[CLEAN$smoke==1], breaks=8)
plot(part1, main="Pre-pregnancy weight of smokers vs non-smokers", xlab="Weight in Pounds", col=rgb(0,0,1,1/4))
plot(part2, col=rgb(1,0,0,1/4), add=T)
...
```{r prob16}
hist(CLEANP$BMI, xlab="BMI(kg/m^2)")
#
```
