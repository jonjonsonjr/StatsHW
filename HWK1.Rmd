...
hist(smoke1$weight, xlab = "Weight (lbs.)",main = "Histogram of Pre-Pregnancy Smoker Weight")
hist(smoke0$weight, xlab = "Weight (lbs.)",main = "Histogram of Pre-Pregnancy Non-Smoker Weight")
#
```

> **Prob 13 answer:** As the above histograms show, the weight distribution between smokers and non-smokers is only slightly skewed.  This is evident from comparison of the median weight of smokers **`r median(smokersweight)`** lbs. and the mean weight of non-smokers **`r mean(nonSmokersweight)`** lbs.
