...
> 5. Let X1,X2, . . . , Xn be a random sample from some distribution and suppose Y = T (X1,X2, . . . , Xn) is a statistic. Suppose the sampling distribution of Y has pdf f(y) = (3/8)y^2 for 0 ≤ y ≤ 2. Find P(0 ≤ Y ≤ 1/5).
...
$\tilde{i.i.d.} N(10, 5^2)$. Let $W = \hat{X} - \hat{Y}$.<br>
a. Give the exact sampling distribution of $W$.<br>
...
standard error are close to the theoretical mean and the standard error.<br>
...
21. Let X1,X2 ~ F with corresponding pdf f (x) = 2/x2, 1 ≤ x ≤ 2.
