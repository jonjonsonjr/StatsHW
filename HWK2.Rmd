...
# Normal Dist in R are in opposite order from the book
# Also our book uses variance so you take the square root of it (or something)
# mu_xbar = mean of samples = mu
# sigmasq_xbar = variance of the distribution of the sample means = sigmasq_x / n_x
# central limit theorem:
#   If you take a "sufficiently large" sample, the resulting sampling distribution for the sample
#   mean will look approximately normal
